      ...
      <Grid container spacing={5} className={Style.row}>
        ...
        <Slide direction="up" in={true} mountOnEnter unmountOnExit>
          <Grid item md={8} xs={12} className={Style.AboutMe}>
            ...
            <Grid container xs={12} spacing={5} className={Style.skillIcon}>
              {/* <Grid item xs={12} className={Style.iconCenter}>
                <h3>My Skills</h3>
              </Grid> */}
        ...
        <Grid container spacing={5} className={Style.Container}>
          <Grid item md={6} xs={12} className={Style.MoreAboutMe}>
            ...
            <p>
              Where I am responsible for setting out which technological
              resources meet the company's short and long-term business goals
              and staying in touch with technology trends and development that
