        ...
        <Grid md={8} xs={12} className={Style.collg8}>
                ...
                <CardContent className={Style.CardText}>
                  <ul>
                    ...
                    <li>
                      ...
                      Workspace, RDS with MariaDB, CodeCommit, CodePipeline and
                      WP with LightSail
                    </li>
                    <li>
                      Overseeing and managing the development of MVP with a team
                      of 3 summer students
                    </li>
                    <li>
                      Successfully launched student-facing MVP of over 49k
                      financial awards valued at over $450M, leading to helping
                      over 300 marginalized students across Canada and the US
                    </li>
                  </ul>
                </CardContent>
              </AccordionDetails>
            ...
            >
              ...
              <AccordionDetails className={Style.CardT}>
                <CardContent className={Style.CardText}>
                  <ul>
                    <li>
                      Built RESTful API within React to connect to MongoDB using
                      AWS Serverless and Lambda Functions
                    </li>
                    <li>
            ...
            >
              ...
              <AccordionDetails className={Style.CardT}>
                <CardContent className={Style.CardText}>
                  <ul>
                    <li>
                      Set up full analytics tracking (Page Data, eCommerce, UX)
                      using Google Tag Manager and Google Analytics
                    </li>
                    <li>
                      Partnered with Analytics Reporters and Account Managers to
                      troubleshoot and develop analytics requirements
                    </li>
                    <li>
                      Utilized JavaScript and jQuery to monitor DOM interaction
                      and react to them for analytic purposes
                    </li>
                    <li>
                      Used Google Optimize for A/B testing to change elements on
                      a page
                    </li>
                    <li>
                      Implemented third-party tracking requirements and
                      platforms, such as Facebook Pixel, to measure Facebook Ads
                      results
                    </li>
                    <li>
          ...
          <Grid container className={Style.Row}>
            ...
            >
              <AccordionSummary>
                <CardContent className={Style.CardText}>
                  <Typography variant="h6">Business Analyst Intern</Typography>
                  <Typography variant="subtitle1">
                    <a
              ...
              <AccordionDetails className={Style.CardT}>
                <CardContent className={Style.CardText}>
                  <ul>
                    ...
                    <li>
                      Contributed to the development of Conceptual Data Analytic
                      Reference Architecture, Data & Analytics Service Model,
                      and Organizational Structure
                    </li>
                    <li>
                      Investigated and attained an understanding of Master Data
                      Management, Metadata Management, Data Quality, and Data
                      Governance
                    </li>
                    <li>
